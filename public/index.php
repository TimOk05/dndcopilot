...
$fastBtns .= '<button class="fast-btn btn btn-primary interactive" onclick="window.open(\'character-generator-new.html\', \'_blank\', \'width=800,height=600,scrollbars=yes,resizable=yes\')" data-tooltip="Создать персонажа" aria-label="Открыть генератор персонажей"><span class="svg-icon icon-hero" data-icon="hero"></span> Персонаж</button>';
