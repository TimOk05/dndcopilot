    ...
    <script>
        async function testRandomPotions() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    document.getElementById('randomResult').innerHTML = `<p style="color: red;">Ошибка: ${data.error}</p>`;
                }
            } catch (error) {
                document.getElementById('randomResult').innerHTML = `<p style="color: red;">Ошибка сети: ${error.message}</p>`;
            }
        }
        ...
        async function testRarities() {
            try {
                ...
                if (data.success) {
                    ...
                    document.getElementById('raritiesResult').innerHTML = `<p style="color: red;">Ошибка: ${data.error}</p>`;
                }
            } catch (error) {
                document.getElementById('raritiesResult').innerHTML = `<p style="color: red;">Ошибка сети: ${error.message}</p>`;
            }
        }
        ...
        async function testTypes() {
            try {
                ...
                if (data.success) {
                    ...
                    document.getElementById('typesResult').innerHTML = `<p style="color: red;">Ошибка: ${data.error}</p>`;
                }
            } catch (error) {
                document.getElementById('typesResult').innerHTML = `<p style="color: red;">Ошибка сети: ${error.message}</p>`;
            }
        }
        ...
        async function testPotionsByType() {
            ...
            try {
                ...
                if (data.success) {
                    let html = `<h4>Зелья типа "${type}":</h4>`;
                    ...
                    document.getElementById('typeResult').innerHTML = `<p style="color: red;">Ошибка: ${data.error}</p>`;
                }
            } catch (error) {
                document.getElementById('typeResult').innerHTML = `<p style="color: red;">Ошибка сети: ${error.message}</p>`;
            }
        }
    </script>
</body>
