...
Сделай описание живым и погружающим (2-3 предложения).";
    ...
    /**
     * Очистка ответа от AI от проблемных символов и служебных фраз
     */
    private function cleanAiResponse($text) {
        // Удаляем служебные фразы AI в начале текста
        $service_phrases = [
            'Конечно, вот перевод, сохраняющий всё очарование и атмосферу оригинала:',
        ...
        foreach ($service_phrases as $phrase) {
