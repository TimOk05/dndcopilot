...
class FallbackData {
    ...
    /**
     * Fallback данные для противников
     */
    public static function getEnemies() {
        return [
            [
                ...
                'actions' => ['Короткий меч', 'Лук'],
                'description' => 'Маленький гуманоид с зеленой кожей и острыми ушами.',
                'tactics' => 'Атакует из засады, использует численное преимущество'
            ],
            [
                'name' => 'Орк',
                'type' => 'humanoid',
                ...
                'actions' => ['Секира', 'Дротик'],
                'description' => 'Крупный гуманоид с зеленой кожей и клыками.',
                'tactics' => 'Прямая атака, полагается на силу и выносливость'
            ],
            [
                'name' => 'Тролль',
                'type' => 'giant',
                ...
                'actions' => ['Когти', 'Укус'],
                'description' => 'Огромное существо с регенерирующей кожей.',
                'tactics' => 'Регенерация, атакует ближайшую цель'
            ],
            [
                'name' => 'Молодой дракон',
                'type' => 'dragon',
                ...
                'actions' => ['Когти', 'Укус', 'Дыхание'],
                'description' => 'Молодой, но уже опасный дракон.',
                'tactics' => 'Использует дыхание, летает для преимущества'
            ],
            [
                'name' => 'Зомби',
                'type' => 'undead',
                ...
                'actions' => ['Кулак'],
                'description' => 'Нежить с медленными движениями.',
                'tactics' => 'Нечувствителен к страху, атакует без устали'
            ],
            [
                'name' => 'Скелет',
                'type' => 'undead',
                ...
                'actions' => ['Короткий меч', 'Лук'],
                'description' => 'Анимированный скелет.',
                'tactics' => 'Использует оружие, атакует на расстоянии'
            ],
            [
                'name' => 'Волк',
                'type' => 'beast',
                ...
                'actions' => ['Укус'],
                'description' => 'Дикий волк с острыми клыками.',
                'tactics' => 'Охотится стаей, использует скорость'
            ],
            [
                'name' => 'Медведь',
                'type' => 'beast',
                ...
                'actions' => ['Когти', 'Укус'],
                'description' => 'Крупный медведь с мощными лапами.',
                'tactics' => 'Атакует в ближнем бою, использует силу'
            ],
            [
                ...
                'actions' => ['Огненный удар', 'Поглощение'],
                'description' => 'Существо из чистой стихии огня.',
                'tactics' => 'Использует огонь, может поглощать противников'
            ],
            [
                'name' => 'Голем',
                'type' => 'construct',
                ...
                'hp' => 178,
                'ac' => 17,
                'abilities' => ['str' => 20, 'dex' => 9, 'con' => 18, 'int' => 3, 'wis' => 10, 'cha' => 1],
                'actions' => ['Кулаки', 'Магическое сопротивление'],
                'description' => 'Магический конструкт из камня.',
                'tactics' => 'Следует командам, устойчив к магии'
            ]
        ];
    }
